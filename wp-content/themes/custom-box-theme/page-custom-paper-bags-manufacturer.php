...
$options = array(
    ...
    array('type' => 'White Die-Cut Handle Bags', 'quote_value' => 'White Die-Cut Handle Paper Bag', 'description' => 'Clean white bags with an integrated handle and CMYK printing for events, product samples, promotions and lightweight retail items.', 'image' => 'white-paper-bag-bright-day.webp', 'width' => 900, 'height' => 900, 'alt' => 'White promotional paper bag with reinforced die-cut handle and CMYK printing'),
    array('type' => 'Coated Paper Shopping Bags', 'quote_value' => 'Coated Paper Shopping Bag', 'description' => 'Matte-coated bags with CMYK artwork and cotton rope handles for cosmetics, fashion, gifts and branded retail collections.', 'image' => 'coated-paper-bag-miren.webp', 'width' => 900, 'height' => 900, 'alt' => 'Matte-coated paper shopping bag with CMYK botanical print and cotton rope handles'),
...
<main id="cpb-main" class="cpb-page" data-quote-success="<?php echo $is_success ? '1' : '0'; ?>">
    <section class="cpb-hero cpb-hero--lead">
        <div class="cpb-shell cpb-hero__grid">
            ...
            <figure class="cpb-hero__media">
                <img src="<?php echo esc_url($asset_uri . 'custom-paper-bags-manufacturing-workshop.webp'); ?>" alt="Workers assembling custom paper shopping bags in a real paper bag manufacturing workshop" width="1400" height="594" fetchpriority="high" decoding="async">
            </figure>
    ...
    <section class="cpb-section cpb-section--ink" id="process"><div class="cpb-shell cpb-process-grid"><div><p class="cpb-eyebrow">Production process</p><h2>From Specification to Packed Paper Bags</h2><p>The exact sequence and timing are confirmed after the bag specification, quantity, sampling needs, and delivery plan are approved.</p><figure class="cpb-process-image"><img src="<?php echo esc_url($asset_uri . 'custom-paper-bags-production-process.webp'); ?>" alt="Paper bag converting machine feeding a paper roll and forming kraft bags in a factory workshop" width="1600" height="900" loading="lazy" decoding="async"><figcaption>Paper bag converting, folding and forming in a factory workshop.</figcaption></figure></div><ol class="cpb-steps"><?php foreach ($steps as $step) : ?><li><span><?php echo esc_html($step['number']); ?></span><div><h3><?php echo esc_html($step['title']); ?></h3><p><?php echo esc_html($step['text']); ?></p></div></li><?php endforeach; ?></ol></div></section>
