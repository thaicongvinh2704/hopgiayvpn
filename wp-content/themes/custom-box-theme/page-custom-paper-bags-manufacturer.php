...
$quick_quote_messages = array(
    'success' => 'Thank you. Your details were sent successfully. Our sales team will review your paper bag request and follow up with the next steps.',
    'failed' => 'We could not send your request right now. Please try again or email sales.vpn@hopgiayvpn.com.',
    'missing' => 'Please enter your name, business email, paper bag type, quantity and delivery country or region.',
...
$form_error_message = ($quote_status && isset($quick_quote_messages[$quote_status])) ? $quick_quote_messages[$quote_status] : '';
...
if ($paper_bag_category && !is_wp_error($paper_bag_category) && class_exists('WP_Query')) {
    ...
    $paper_bag_product_ids = get_posts(array(
        ...
        'post_status'         => 'publish',
        'posts_per_page'      => 8,
        'post_name__in'       => $paper_bag_product_slugs,
...
<main id="cpb-main" class="cpb-page" data-quote-success="<?php echo $is_success ? '1' : '0'; ?>">
    <section class="cpb-hero cpb-hero--lead">
        <div class="cpb-shell cpb-hero__grid">
            <div class="cpb-hero__copy">
                <p class="cpb-eyebrow">Custom Paper Bag Manufacturer in Vietnam</p>
                <h1>Custom Paper Bag Manufacturer in Vietnam for Brands &amp; B2B Buyers</h1>
                <p class="cpb-hero__lead">VPN Paper Box manufactures custom paper bags for brands, retailers, importers and distributors. We review finished size, product weight, paper, handles, artwork, printing and delivery requirements before quotation.</p>
                <ul class="cpb-hero__trust"><li>Kraft, coated, recycled and specialty paper options</li><li>Twisted paper, flat paper, rope, ribbon and die-cut handles</li><li>One-color, CMYK, Pantone and premium finishing options</li></ul>
                <div class="cpb-actions"><a class="cpb-button" href="#quote" data-track="paper_bag_quote_cta">Request a Custom Paper Bag Quote</a><a class="cpb-button cpb-button--ghost" href="https://wa.me/84933102653" target="_blank" rel="noopener" data-track="paper_bag_whatsapp_click">Chat With Our Sales Team</a></div>
            ...
            <aside class="cpb-hero__quick-card" id="cpb-hero-quick-quote" aria-labelledby="cpb-hero-quick-quote-title">
                <div class="cpb-hero__quick-card-head">
                    <h2 id="cpb-hero-quick-quote-title">Request a Quick Paper Bag Quote</h2>
                    <p>Share the basic project details below. Our sales team will review your paper bag requirements and respond with the next steps.</p>
                </div>
                ...
                <form class="cpb-quick-form" action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="post">
                    ...
                    <div class="cpb-quick-fields">
                        ...
                        <label>
                            <span>Delivery country or region</span>
    ...
    <section class="cpb-final-cta"><div class="cpb-shell cpb-final-cta__inner"><div><p class="cpb-eyebrow">Ready to develop your custom paper bag?</p><h2>Send your size, quantity, artwork, and delivery country for a project-specific review.</h2></div><div class="cpb-actions"><a class="cpb-button cpb-button--light" href="#quote" data-track="paper_bag_quote_cta">Request a Custom Paper Bag Quote</a><a class="cpb-button cpb-button--outline-light" href="https://wa.me/84933102653" target="_blank" rel="noopener" data-track="paper_bag_whatsapp_click">Chat With Our Sales Team</a></div></div></section>
</main>
