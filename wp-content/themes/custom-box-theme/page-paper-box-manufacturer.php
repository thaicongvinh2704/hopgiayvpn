...
<style>
    ...
    .vpn-lp-hero::before { background-image: url("<?php echo esc_url($image_url('paper-box-factory-production-workflow.webp')); ?>"); background-position: center; background-repeat: no-repeat; background-size: cover; content: ""; inset: 0; position: absolute; transform: scaleX(-1); transform-origin: center; z-index: 0; }
