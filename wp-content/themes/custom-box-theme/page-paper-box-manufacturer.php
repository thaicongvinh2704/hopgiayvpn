...
<style>
    ...
    .vpn-lp-hero::before { background-image: url("<?php echo esc_url($image_url('z7943070206531_9aeff7a9a15c59a3a1c1295e65897b7e.jpg')); ?>"); background-position: center; background-repeat: no-repeat; background-size: cover; content: ""; inset: 0; position: absolute; transform: scaleX(-1); transform-origin: center; z-index: 0; }
