...
$fallback_gallery = array(
    array(
        ...
        'url' => home_url('/products/rigid-boxes/'),
    ),
    array(
        ...
        'url' => home_url('/products/cosmetic-paper-boxes/'),
    ),
    array(
    ...
    array(
        'image' => $theme_uri . '/assets/images/gift-box2.webp',
        'alt' => 'custom gift paper box packaging',
        'title' => 'Premium Gift Box Packaging',
        'meta' => 'Gift packaging',
        'url' => home_url('/products/gift-paper-boxes/'),
    ),
    array(
        ...
        'url' => home_url('/products/paper-bags-with-logo/'),
    ),
    array(
        'image' => $theme_uri . '/assets/images/Takeout-Boxes_1758880241.webp',
        'alt' => 'food packaging paper box factory',
        'title' => 'Food Paper Box Packaging',
        'meta' => 'Food-grade packaging',
        'url' => home_url('/products/food-paper-boxes/'),
    ),
);
...
$catalog_context = array(
    ...
    'categories' => array(
        array(
            ...
            'image' => vpn_catalog_category_image(array('luxury-rigid-gift-boxes', 'rigid-sliding-drawer-boxes', 'luxury-drawer-gift-boxes'), $theme_uri . '/assets/images/gift-box2.webp'),
        ...
        array(
            ...
            'image' => $theme_uri . '/assets/images/Tuck-Top-Boxes_1758880242.webp',
        ...
        array(
            ...
            'image' => vpn_catalog_category_image(array('cosmetic-set-packaging-boxes', 'luxury-perfume-packaging-boxes', 'cosmetic-mailer-packaging-boxes'), $theme_uri . '/assets/images/gift-box.webp'),
        ...
        array(
            ...
            'image' => vpn_catalog_category_image(array('bakery-food-packaging-boxes', 'custom-cake-packaging-boxes', 'pizza-packaging-boxes', 'custom-chocolate-gift-boxes'), $theme_uri . '/assets/images/Takeout-Boxes_1758880241.webp'),
        ...
        array(
            ...
            'image' => vpn_catalog_category_image(array('luxury-drawer-gift-boxes', 'luxury-rigid-gift-boxes', 'premium-ribbon-gift-boxes', 'mooncake-gift-packaging-boxes'), $theme_uri . '/assets/images/gift-box2.webp'),
        ...
        array(
            ...
            'url' => home_url('/products/jewelry-paper-boxes/'),
        ),
        array(
            'title' => 'Wine & Beverage Boxes',
            'description' => 'Custom paper boxes for wine, beverage, bottle packaging, and gift packaging projects.',
            'image' => vpn_catalog_category_image(array('luxury-wine-bottle-packaging-boxes', 'wine-bottle-gift-boxes'), $theme_uri . '/assets/images/gift-box.webp'),
            'alt' => 'wine beverage paper box manufacturer',
            'url' => home_url('/products/wine-premium-drink-packaging/'),
        ),
        array(
