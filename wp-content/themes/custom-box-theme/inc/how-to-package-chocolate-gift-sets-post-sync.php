...
function custom_box_sync_chocolate_gift_sets_packaging_post(): void
{
    ...
    if ('2026-07-13-v1' === get_option('custom_box_chocolate_gift_sets_packaging_sync_version')) {
        return;
    }
    ...
    update_option('custom_box_chocolate_gift_sets_packaging_sync_version', '2026-07-13-v1', false);
}
