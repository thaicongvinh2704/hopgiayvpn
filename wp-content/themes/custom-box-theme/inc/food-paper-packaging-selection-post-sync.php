...
function custom_box_sync_food_paper_packaging_selection_post(): void
{
    ...
    if ('2026-07-13-v1' === get_option('custom_box_food_paper_packaging_selection_sync_version')) {
        return;
    }
    ...
    update_option('custom_box_food_paper_packaging_selection_sync_version', '2026-07-13-v1', false);
}
