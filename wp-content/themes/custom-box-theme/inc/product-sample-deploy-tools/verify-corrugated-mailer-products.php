<?php
/**
 * Verify July 2026 corrugated mailer product import.
 *
 * Run:
 *   php tools/verify-corrugated-mailer-products.php
 */
...
foreach ( $expected as $slug ) {
	...
	if ( ! $found || $marker !== get_post_meta( $found->ID, '_vpn_sample_import', true ) ) {
		$failures[] = 'Missing expected corrugated mailer product: ' . $slug . '.';
	}
}
...
echo 'Verified corrugated mailer products successfully.' . PHP_EOL;
