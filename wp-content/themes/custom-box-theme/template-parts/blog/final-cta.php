...
<section class="blog-final-cta">
    <div>
        <span><?php esc_html_e('Ready for Production?', 'custom-box-theme'); ?></span>
        <h2><?php esc_html_e('Build Custom Packaging That Fits Your Product, Brand, and Budget', 'custom-box-theme'); ?></h2>
