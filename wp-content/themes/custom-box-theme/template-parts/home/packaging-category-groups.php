...
$category_groups = array(
    ...
    array(
        ...
        'items' => array(
            ...
            array('Medicine Packaging Boxes', 'medicine-packaging-boxes', $theme_image_uri . 'custom-pharmaceutical-medicine-packaging-boxes-gray-background.webp'),
    ...
    array(
        ...
        'items' => array(
            ...
            array('Hardware Accessories Packaging', 'hardware-accessories-packaging', $theme_image_uri . 'custom-phone-accessories-packaging-boxes-gray-background.webp'),
            ...
            array('Capsule Oil Packaging', 'capsule-oil-packaging', $old_category_image_uri . '40.jpg'),
            array('Mouse and Display Packaging', 'mouse-display-packaging', $theme_image_uri . 'custom-home-lifestyle-product-packaging-boxes-gray-background.webp'),
            array('Kraft School and Stationery Packaging', 'kraft-school-stationery-packaging', $theme_image_uri . 'custom-stationery-school-supplies-packaging-boxes-gray-background.webp'),
        ),
    ),
);
?>
