...
<header class="vpn-lp-minimal-header">
    ...
    <div class="vpn-lp-minimal-header__drawer" id="pbm-mobile-menu" hidden data-pbm-mobile-menu>
        ...
        <a href="<?php echo esc_url(function_exists('custom_box_custom_paper_bags_url') ? custom_box_custom_paper_bags_url() : home_url('/custom-paper-bags-manufacturer/')); ?>"><?php esc_html_e('Paper Bags', 'custom-box-theme'); ?></a>
