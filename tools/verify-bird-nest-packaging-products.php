<?php
/**
 * Verify bird nest packaging products imported from uploaded Media Library images.
 *
 * Run:
 *   php tools/verify-bird-nest-packaging-products.php
 */
...
foreach ( $products as $product ) {
	...
	if ( is_wp_error( $terms ) || ! in_array( 'bird-nest-packaging-boxes', $terms, true ) ) {
		$failures[] = $title . ': missing Bird Nest Packaging Boxes category.';
	}
	if ( is_array( $specs ) ) {
...
echo 'Verified ' . count( $products ) . ' bird nest packaging products successfully.' . PHP_EOL;
