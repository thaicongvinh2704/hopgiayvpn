<?php
/**
 * Run the environmentally friendly packaging materials post sync locally.
 *
 * Usage: php tools/import-environmentally-friendly-packaging-materials.php [import|audit]
 */
...
require_once get_template_directory() . '/inc/environmentally-friendly-packaging-materials-post-sync.php';
