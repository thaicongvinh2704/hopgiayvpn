...
function vpn_fashion_upload_attachment_id( string $source_relative_path, string $alt, string $title ): int {
	...
	$filename    = wp_unique_filename( $target_dir, basename( $source_path ) );
...
$products = array(
	...
	array(
		...
		'images' => array(
			...
			'wp-content/themes/fasion/custom-sportswear-packaging-box-images/custom-sportswear-packaging-box-02.webp',
			'wp-content/themes/fasion/custom-sportswear-packaging-box-images/custom-sportswear-packaging-box-03.webp',
		...
		'captions' => array(
			...
			'Sportswear packaging box for folded apparel and fitness product branding.',
			'Custom paper box for sportswear with clean product presentation.',
	...
	array(
		...
		'images' => array(
			...
			'wp-content/themes/fasion/custom-t-shirt-packaging-box-images/custom-t-shirt-packaging-box-open-minimal-white-shirt-03.webp',
		...
		'captions' => array(
			...
			'Minimal T-shirt packaging box for clean fashion brand presentation.',
